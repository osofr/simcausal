...
We note that the \pkg{simcausal} package differs from other R packages \citep{R-lavaan,R-lavaan.survey,R-sem,R-semPLS,R-OpenMx} that implement data simulation based on
